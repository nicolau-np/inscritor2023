                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            {{ Form::select(
                                                ...
                                                null,
                                                ['placeholder' => 'Nível de Acesso', 'class' => 'form-control'],
                                            ) }}
                                            ...
                                            <tbody>
                                                @foreach ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/instituicaos/users/reset_passe/{{ $user->id }}"
                                                                class="btn btn-warning btn-sm">Resetar Passe</a>
                                                            &nbsp;
                                                            <a href="/instituicaos/users/destroy/{{ $user->id }}"
