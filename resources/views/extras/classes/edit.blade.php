...
<div class="content">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    {{Form::open(['url'=>"/extras/classes/{$classe->id}", 'method'=>"put"])}}
                    @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        {{Form::text('classe', $classe->classe,
                                        ['placeholder'=>"Classe",
                                        'class'=>"form-control"])}}
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Instituição <span
                                                class="text-danger">*</span></label>
                                                {{Form::select('id_instituicao', $instituicaos->pluck('instituicao', 'id'), $classe->id_instituicao, ['placeholder'=>"Instituição", 'class'=>"form-control"])}}
