...
<div class="content">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    {{Form::open(['url'=>"/extras/turmas/{$turma->id}", 'method'=>"put"])}}
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="">Instituição <span
                                                ...
                                                {{Form::select('id_instituicao', $instituicaos->pluck('instituicao', 'id'),$turma->id_instituicao, ['placeholder'=>"Instituição", 'class'=>"form-control", 'id'=>"instituicao"])}}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{Form::text('turma',$turma->turma, ['placeholder'=>"Turma", 'class'=>"form-control"])}}
                                    ...
                                    <div class="col-md-5">
                                        <label for="">Curso <span
                                                class="text-danger">*</span></label>
                                        <span id="load-cursos">
                                            {{Form::select('id_curso', $cursos->pluck('curso', 'id'), $turma->id_curso,
                                            ['placeholder'=>"Curso",
                                            'class'=>"form-control"])}}
                                        </span>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <span id="load-classes">
                                            {{Form::select('id_classe',$classes->pluck('classe', 'id'), $turma->id_classe,
                                            ['placeholder'=>"Classe",
                                            'class'=>"form-control"])}}
                                        </span>
                                    ...
                                    <div class="col-md-3">
                                        <label for="">Ano Lectivo <span
                                                class="text-danger">*</span></label>
                                        <span id="load-anos">
                                            {{Form::select('id_ano_lectivo',$ano_lectivos->pluck('ano', 'id'), $turma->id_ano_lectivo,
