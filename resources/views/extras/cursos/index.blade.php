              ...
              <div class="row">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            &nbsp;
                            {{--<a href="/extras/cursos/destroy/{{$estudante->id}}" class="btn btn-danger btn-sm">Eliminar</a>--}}
                        </td>
                      </tr>
                     @endforeach
                    </tbody>
                ...
                <div class="paginate">
                    ...
                    <ul class="pagination justify-content-center m-0">
                        ...
                        @else
                            <li> <a href="{{ $cursos->previousPageUrl() }}" rel="prev"><span>
                        ...
                        @if ($cursos->hasMorePages())
                            <li> <a href="{{ $cursos->nextPageUrl() }}" rel="next"><span>
